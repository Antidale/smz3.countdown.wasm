...
namespace smz3.countdown.wasm.Enums
{
    public enum Area
    {
        ...
        [Area("Death Mountain", "Death Mountain", "Light World Death Mountain East")]
        LightWorldDeathMountainEast,

        [Area("Eastern Palace", "Eastern Palace", "Eastern Palace")]
        EasternPalace,

        [Area("Desert Palace", "Desert Palace", "Desert Palace")]
        DesertPalace,
        ...
        [Area("Skull Woods", "Skull Woods", "Skull Woods")]
        SkullWoods,

        [Area("Thieves' Town", "Thieves' Town", "Thieves' Town")]
        ThievesTown,

        [Area("Ice Palace", "Ice Palace", "Ice Palace")]
        IcePalace,

        [Area("Misery Mire", "Misery Mire", "Misery Mire")]
        MiseryMire,

        [Area("Turtle Rock", "Turtle Rock", "Turtle Rock")]
        TurtleRock,
        ...
        [Area("Crateria", "Crateria", "Crateria West")]
        CrateriaWest,
        ...
        [Area("Brinstar", "Brinstar", "Brinstar Blue")]
        BrinstarBlue,

        [Area("Brinstar", "Brinstar", "Brinstar Green")]
        BrinstarGreen,

        [Area("Brinstar", "Brinstar", "Brinstar Pink")]
        BrinstarPink,
